 ...
 */
fun ImageView.setImage(imgSource: Any?, placeholder: Int = R.drawable.bg_gray_gradient, error: Int = R.mipmap.ic_launcher_round) {
...
fun ImageView.setImageReading(imgSource: Any?, placeholder: Int = R.drawable.bg_gray_gradient, error: Int = R.mipmap.ic_launcher_round) {
    val requestOptions = RequestOptions()
            .fitCenter()
            .placeholder(placeholder)
