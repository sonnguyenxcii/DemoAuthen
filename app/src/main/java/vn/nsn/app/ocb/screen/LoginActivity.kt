...
import vn.nsn.app.ocb.screen.active.ActiveAppActivity
...
import vn.nsn.app.ocb.util.ForegroundCheckTask
...
class LoginActivity : MvpActivity<CreatePinCodePresenter>(), CreatePinCodeContract, View.OnClickListener {
    ...
    override fun initViews() {
        loadLang()
//        println("-------------------" + isAppIsInBackground(this))
...
//            securityDevice.setPin("123456") //please remember the PIN you set
